...
func (manager *containerManager) CreateContainer(
	...
	if manager.createWithClone {
		...
		err = callback(instance.StatusProvisioning, "Cloning template container", nil)
		if err != nil {
	...
	callback(instance.StatusProvisioning, "Configuring container", nil)
	...
	callback(instance.StatusProvisioning, "Starting container", nil)
	...
	callback(instance.StatusRunning, "Container started", nil)
